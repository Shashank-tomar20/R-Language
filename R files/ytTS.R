...
plot(decomp$figure,
     ...
     col = 'blue',
     las = 2)    #Sets the style of the axis labels: always parallel to the axis (0, default), always horizontal (1), always perpendicular to the axis (2), and always vertical (3). I often set the las = 1 to ensure that the y-axis labels are easier to read
plot(decomp)
